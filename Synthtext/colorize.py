...
class Colorize(object):
    ...
    def color(self, text_arr, bg_arr, fg_col, bg_col, colorsRGB, colorsLAB, min_h, param):
        ...
        bg_col = np.mean(np.mean(bg_arr, axis=0), axis=0)  # 获取背景的平均颜色
...
def get_color_matrix(col_file):
    ...
    return colorsRGB, colorsLAB  # (4941,12)(9882,3)
...
if __name__ == '__main__':
    get_color_matrix('/data1/lily/Gen-data/SRnet-datagen/Synthtext/data/colors_new.cp')
